			...
			<div class="pd-20 card-box mb-30">
				...
				<form id="reg_form" action="#" method="post">
					<div class="form-group row">
						...
						<div class="col-md-4">
							<label class="col-sm-12 col-md-5 col-form-label">Name</label>
                    ...
                    <div class="form-group row">
						...
						<div class="col-md-4">
							<label class="col-sm-12 col-md-5 col-form-label">Profession</label>
                    ...
                    <div class="form-group row">
						...
						<div class="col-md-4">
							<label class="col-sm-12 col-md-5 col-form-label">Description</label>
				 ...
				 <h3 style="text-align:center;">Teacher Data</h3>
				  <br>         
				  <table class="table">
				    <thead>
				      <tr>
				    ...
				    <tbody>
				    	<?php
				    		$stu_class = select("trainers");
				    		if($stu_class != null)
				    			$count=1;{
				    				foreach ($stu_class as $stu_row) {
				    					$stu_id    = $stu_row['id'];
				    					$stu_title = $stu_row['name'];
                                        $stu_content = $stu_row['profession'];
                                        $stu_features = $stu_row['description'];
