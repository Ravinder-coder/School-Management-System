			...
			<div class="pd-20 card-box mb-30">
				...
				<form id="reg_form" action="#" method="post">
					<div class="form-group row">
						...
						<div class="col-md-4">
							<label class="col-sm-12 col-md-5 col-form-label">Class Name</label>
							<input class="form-control" type="text" name="classname" placeholder="Enter Class Name">
						</div>
					</div>
                    <div class="form-group row">
						<div class="col-md-4">		
						...
						<div class="col-md-4">
							<label class="col-sm-12 col-md-5 col-form-label">Admission Class</label>
							<input class="form-control" type="text" name="admissionclass" placeholder="Enter Admission Class">
						</div>
					</div>
                    <div class="form-group row">
						<div class="col-md-4">		
				 ...
				 <h3 style="text-align:center;">Courses Data</h3>
				  <br>         
				  <table class="table">
				    <thead>
				      <tr>
				    ...
				    <tbody>
				    	<?php
				    		$stu_class = select("courses");
				    		if($stu_class != null)
				    			$count=1;{
				    				foreach ($stu_class as $stu_row) {
				    					$stu_id    = $stu_row['id'];
				    					$stu_classname = $stu_row['classname'];
                                        $stu_admissionclass = $stu_row['admissionclass'];
